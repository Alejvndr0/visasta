...
<head>
    ...
    <style>
        ...
        .topbar-login .dropdown-item:hover {
            background-color: #007bff;
            color: #fff;
        }
        .topbar-login .btn-login {
            background-color: #007bff;
            color: #fff;
            padding: 5px 15px;
            border-radius: 20px;
        ...
        .topbar-login .dropdown-toggle::after {
            border-top-color: #007bff;
        }
    </style>

    <!-- Scripts -->
    @vite(['resources/js/main.js', 'resources/lib/easing/easing.min.js'])
    @vite(['resources/css/style.css', 'resources/lib/owlcarousel/assets/owl.carousel.min.css', 'resources/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css'])
